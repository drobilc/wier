...
class OverstockRegexExtractor(BaseExtractor):
...
class RTVSloRegexExtractor(BaseExtractor):
...
class AvtoNetRegexExtractor(BaseExtractor):
    ...
    def extract_data(self, content):
        ...
        title_matches = re.findall(title_regex, content)
        link_matches = re.findall(link_regex, content)
